...
These variables allow us to identify the location of the recipient.  
...
* costmon - The variable fed_funding_amount was divided by res_duration to establish the common base for comparing amounts allocated to different recipients.
...
We also noted some seasonal cyclicity over the 16-year period, where approximately every three years, there appears to be an upswing in grant amounts. \vspace{20 mm}
...
Strong bimodal cost trend for revised grants, both modes are lower than continuing and new grants.
New grants are generally more expensive and the frequency of higher costs is higher than among continuing grants.
...
```
New grants do not last longer than 100 months 
Revised and Continuing grants are longer in duration
...
```
Decrease in variance towards the end of the year
greatest number of outliers for New and Continuing grants - summer and fall
greates number of positive outliers in revisions - same calendar trends as for other types 
...
```
STEM fields are consistently recieving the highest annual total allocations
Education and Human Resources - unusual to see it among technical sciences
STEM fields recieve 500 million - 1.5 billion a year consistently 
distribution is relatively normal - small skews , variance is very high
\section{States}
...
California, New York, Massachussetts and Washington, D.C. are the states with the highest annual cumulative allocations. Annual variance is high for these states, but being a recipient state with the most allocations is consistent across 1999-2016. 
The range is significant - every tick is 300 million dollars. For example, the range for  California is 500 m - 1 billion, which is the difference of 500 million dollars between the highest and lowest years for this state. 
...
California, New York and Washington, D.C. consistently show more negative outliers (small grants) than other states given that medians with minor variations are roughly similar for most of the largest states and the upper bounds for larger grants are roughly the same as well.
...
The largest amounts consistently distributed in summmer months and September - activity significantly slows down in the fall and winter
Activity peaks in August and is slightly lower in September. We can conclude that annual NSF cycle is October - September
...
Frequency changes month - to month, most significantly in revised grants, creating a bimodal distribution 
Continue and New - some shifts in allocations plus frequency varies making most frequent values more or less distinct depending on the month
...
Highest cumulative amounts among state and private higher education institutions and "All other" but also the dispersion is quite high - it seems like there is no fixed proportion of total grant dollars that higher education institutions are recieving each year. 
